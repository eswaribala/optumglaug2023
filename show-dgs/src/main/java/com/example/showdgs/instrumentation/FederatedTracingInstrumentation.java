package com.example.showdgs.instrumentation;


import com.example.showdgs.models.TracingState;
...
public class FederatedTracingInstrumentation extends SimpleInstrumentation {
    private final static Logger LOGGER = LoggerFactory.getLogger(FederatedTracingInstrumentation.class);
